...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void testStack() throws Exception {
		UriCrawler uriCrawler = new UriCrawler(2);
		URI uriOne = TRIVIAL_URI;
		uriCrawler.addUri(uriOne);
		URI uriTwo = DUPLICATE_URI;
		uriCrawler.addUri(uriTwo);
		
		URI uriFirst = uriCrawler.getNext();
		URI uriSecond = uriCrawler.getNext();
		
		assertEquals(DUPLICATE_URI, uriFirst);
		assertEquals(TRIVIAL_URI, uriSecond);
	}
}
