...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void testHueDistanceAcrossZero() {
		//assertEquals(128, TileFactory.hueDistance(128, 0));
	...
	@Test
	public void testCountTilesZero() {
		assertEquals(redOnlyTileFactory.getTileCount(0),0);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testCountTilesError() {
		redOnlyTileFactory.getTileCount(55);
	}
	
	@Test
	public void testCountTilesMultiple() {
		List<BufferedImage> redImages = ImageUtils.loadFromDirectory(new File(RESOURCE_DIR + "red"));
		redOnlyTileFactory.addImage(redImages.get(0));
		int key = redOnlyTileFactory.addImage(redImages.get(1));
		assertEquals(redOnlyTileFactory.getTileCount(key),2);
	}
	
	@Test
	public void testRemoveAllTiles() {
		List<BufferedImage> redImages = ImageUtils.loadFromDirectory(new File(RESOURCE_DIR + "red"));
		int key = redOnlyTileFactory.addImage(redImages.get(0));
		boolean success = redOnlyTileFactory.removeTiles(key);
		assertTrue(success);
		assertEquals(redOnlyTileFactory.getTileCount(key),0);
	}
	
	@Test
	public void testRemoveAllTilesEmpty() {
		assertFalse(redOnlyTileFactory.removeTiles(0));
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testRemoveAllTilesError() {
		redOnlyTileFactory.removeTiles(55);
	}
}
