...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void testFindMarcEmpty() {
		assertEquals(-1, StringExercises.findDavid(""));
	}

	@Test
	public void testFindMarcExact() {
		assertEquals(0, StringExercises.findDavid("David"));
	}
	...
	public void testFindMarc2() {
		assertEquals(2, StringExercises.findDavid("  David  "));
	}
	...
	public void testFirstFourExact() {
		assertEquals("Susan", StringExercises.firstFive("Susan"));
	}

	@Test
	public void testFirstFour() {
		assertEquals("Smart", StringExercises.firstFive("Smartwatch"));
	}
