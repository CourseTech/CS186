...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void testCountCharactersEmpty() {
		assertEquals(0, ListExercises.findLongestStringLength(new ArrayList<String>()));
	}
	
	@Test
	public void testCountCharactersEmptyString() {
		assertEquals(0, ListExercises.findLongestStringLength(Arrays.asList("")));
	}
	...
	public void testCountCharactersOneString() {
		assertEquals(9, ListExercises.findLongestStringLength(Arrays.asList("asdf jkl;")));
	}

	@Test
	public void testCountCharactersThreeStrings() {
		assertEquals(9, ListExercises.findLongestStringLength(Arrays.asList("asdf jkl;", "", "123456")));
	}
