...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	public void testRotateRightNames() {		
		names.rotateLeft(6);
		assertEquals(Arrays.asList( "Washington","Kelly","John","Justine", 
				"Jingleheimer","Suzanne","John","Patrice"), 
				names);
	}
	...
	public void testRotateRightNamesFurther() {		
		names.rotateLeft(8);
		assertEquals(Arrays.asList( "John","Justine", "Jingleheimer","Suzanne",
				"John","Patrice", "Washington","Kelly"), 
				names);
	}
